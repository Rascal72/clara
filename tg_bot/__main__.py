...
ഹായ് {}, എന്റെ പേര് {}! ഞാൻ [𝙎𝘼𝙉𝙐](tg://user?id=5283476654) നോക്കി നടത്തുന്ന ഒരു അടിപൊളി അഡ്മിൻ ബോട്ടാണ്.
എന്നെ നിർമ്മിച്ചിരിക്കുന്നത് python3 യിൽ python-telegram-bot ലൈബ്രറി ഉപയോഗിച്ചാണ്.



എന്റെ അപ്ഡേറ്റുകളെക്കുറിച്ചും പ്രവർത്തനത്തെപറ്റിയും അറിയുവാൻ @sanubots ചാനൽ സബ്സ്ക്രൈബ് ചെയ്യുക.
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username))],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/aboutme_sanu"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/sanubots")],
                     [InlineKeyboardButton(text="🎬 Movie Channel", url="https://t.me/sanusmoviesch"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
